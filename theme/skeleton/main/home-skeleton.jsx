...
export default function HomeSkeleton() {
  return (
    <View>
      ...
      <View className="p-4 mt-4 w-full flex flex-row flex-wrap justify-between">
        <Skeleton backgroundColor="#ccc" className="w-[45%] h-[150px] rounded-xl" />
        <Skeleton backgroundColor="#ccc" className="w-[45%] h-[150px] rounded-xl" />
        <Skeleton backgroundColor="#ccc" className="w-[45%] h-[50px] rounded-xl mt-6" />
        <Skeleton backgroundColor="#ccc" className="w-[45%] h-[50px] rounded-xl mt-6" />
      </View>
